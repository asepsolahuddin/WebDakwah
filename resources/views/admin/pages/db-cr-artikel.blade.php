  ...
  <div class="row">
      <div class="col-md-12">
          <div class="card border-0 shadow-sm rounded">
              <div class="card-body">
                  <form action="{{ route('dbartikels.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3">
                      ...
                      <div class="form-group mb-3">
                        ...
                        <textarea class="form-control @error('tag_line') is-invalid @enderror" name='tag_line'  placeholder="Masukkan Ringkasan isi artikel">{{ old('tag_line') }}</textarea>
